...
const Landing = () => {
    ...
    return (<>
        <Container maxWidth="lg" style={{ paddingBottom: 64, animation: "fadein 0.3s ease" }}>
            <Box my={4}>
                <Typography className={clsx(classes.cool)}
                    variant="h6">{process.env.REACT_APP_NAME?.toUpperCase()}</Typography>
                <br />
                <Typography variant="h4" gutterBottom style={{ fontFamily: "doublewide", fontWeight: 700 }}>
                    THE FILE HOSTING PLATFORM FOR THE VIEWERS</Typography>
                <br />
                <Typography>
