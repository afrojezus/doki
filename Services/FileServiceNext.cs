    ...
    public static readonly List<string> BinaryExtensions = new List<string>
{
    ...
    public async Task<int> Delete(int id)
    {
      try
      {
        ...
        if (_dbContext.Files.Any(x => x.Author.AuthorId == author) == false)
        {
          _dbContext.Author.Remove(new Author { AuthorId = author });
        }
    ...
    public DokiFile CreateObjectFile(string filename, Author author, string folder)
    {
